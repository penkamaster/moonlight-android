package com.limelightDaydream.preferences;
...
public class PreferenceConfiguration {
    ...
    private static final String ENABLE_DAYDREAM_PREF_STRING = "checkbox_daydream";
    ...
    private static final boolean DEFAULT_ENABLE_DAYDREAM = false;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.enableDaydream = prefs.getBoolean(ENABLE_DAYDREAM_PREF_STRING, DEFAULT_ENABLE_DAYDREAM);
